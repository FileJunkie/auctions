...
document.write('<tr style="background:#FF9900;font:12px Arial;color:#FFFFFF"><td align=center>M</td><td align=center>T</td><td align=center>W</td><td align=center>T</td><td align=center>F</td><td align=center>S</td><td align=center>S</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#FFC266" onclick="today()">Today is: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
